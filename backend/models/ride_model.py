...
class Ride(Document):
    ...
    pickup_latitude = StringField(required=True)
    pickup_longitude = StringField(required=True)
    
    dropoff_address = StringField(required=True, max_length=200)
    dropoff_latitude = StringField(required=True)
    dropoff_longitude = StringField(required=True)
